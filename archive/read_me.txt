This folder contains old R update scripts. 

Currently, the original update script is here, which ran hourly updates for a singular workflow. Conditional logic here determined whether just
